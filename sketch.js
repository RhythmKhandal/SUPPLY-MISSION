...
function setup() {
	...
	groundSprite=createSprite(width/2, 685, width,10);
	...
	grassSprite1=createSprite(40,639,20,20);
	grassSprite1.addImage(grassIMG1)
	grassSprite1.scale=1

	grassSprite2=createSprite(120,639,20,20);
	grassSprite2.addImage(grassIMG1)
	grassSprite2.scale=1

	grassSprite3=createSprite(200,639,20,20);
	...
	grassSprite6=createSprite(560,639,20,20);
	grassSprite6.addImage(grassIMG1)
	grassSprite6.scale=1

	grassSprite7=createSprite(640,639,20,20);
	grassSprite7.addImage(grassIMG1)
	grassSprite7.scale=1

	grassSprite8=createSprite(720,639,20,20);
	grassSprite8.addImage(grassIMG1)
	grassSprite8.scale=1

	rect1=createSprite(290,630,20,100)
	rect2=createSprite(380,670,200,20)
	rect3=createSprite(490,630,20,100)
